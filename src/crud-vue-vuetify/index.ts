...
Vue.component('crud-radio-buttons', RadioButtons);
// Vue.component("crud-checkboxes", FormCheckboxes);
// Vue.component("crud-select", FormSelect);
Vue.component('crud-color-picker', ColorPicker);
// Vue.component("crud-text-area", FormTextArea);

// Vue.component("crud-hr", FormHr);
// Vue.component("crud-heading-big", FormHeadingBig);
Vue.component('crud-paragraph', Paragraph);
// Vue.component("crud-paragraph", FormParagraph);
